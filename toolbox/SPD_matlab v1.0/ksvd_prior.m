function [params] = ksvd_prior(params)
%KSVD_PRIOR denoising of 2-D signals.
%  KSVD_PRIOR denoises a 2-dimensional signal using OMP denoising. The
